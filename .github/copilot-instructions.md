...
- Before implementing a meaningful feature or behavior change, check the relevant spec in docs/specs/ and the related ticket in docs/tickets/.
- If no matching spec or ticket exists, create one before coding.
...
- Use docs/tickets/ for implementation-sized work with clear scope and validation steps.
