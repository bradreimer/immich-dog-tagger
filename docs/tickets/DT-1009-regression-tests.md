# DT-1009: End-to-end and regression test suite
...
[v1.0.0 Product & Engineering Specification](../specs/v1.0.0.md) -- section 7 (Acceptance criteria)
...
Each service in the review -> reclassify loop had unit-level coverage, but nothing exercised them together end-to-end the way a real user session would -- exactly where cross-service regressions (like the DT-1003 leakage defect) hide.
...
Added `tests/test_e2e_review_learning_loop.py`, exercising the real services together (not mocked) end-to-end:
...
The critical user journey (all 14 scenarios above) is covered by automated tests and passes on a clean environment.

## **Testing requirements**

`tests/test_e2e_review_learning_loop.py`.

## **Dependencies**

DT-1001, DT-1002, DT-1003, DT-1004, DT-1005.

## **Suggested commit message**

`test(DT-1009): add end-to-end review-driven learning loop coverage`
